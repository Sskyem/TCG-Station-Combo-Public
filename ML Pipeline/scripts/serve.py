    ...
    <section class="tab-panel" data-tab="training">
      <details class="panel collapsible-panel" open>
        ...
        <div class="form-group">
          ...
          <div id="train-sources" class="row" title="Which decision-log contexts to train on. 'benchmark' = Algorithm-vs-Algorithm runs (fast, mass scale); 'interactive' = watchable AI-vs-AI / Human-vs-AI; 'legacy' = older files in the Decisions/ root. Only AlgorithmBrain decisions are ever logged. Untick all to fall back to the backend default (every non-legacy source).">
