...
REM Localhost-only variant: binds the dashboard to 127.0.0.1 so it is reachable
REM ONLY from this machine. Use this when you do not want the server exposed on
REM the local network. For LAN access (other devices / a phone), use
REM start_dashboard_WINDOWS.cmd instead, which binds 0.0.0.0.
